...
class AG3DDiscriminator(torch.nn.Module):
    def __init__(self, **kwargs):
        ...
        kwargs_image['img_resolution'] = kwargs_image['img_resolution']//2
        ...
        kwargs_lr['img_resolution'] = kwargs_lr['img_resolution']//2
        # kwargs_normal['img_resolution'] = (kwargs_normal['img_resolution']//2, kwargs_normal['img_resolution']//4)
        kwargs_lr['img_channels'] = 3
        # self.D_lr= DualDiscriminator(resolution_scale=1, **kwargs_lr)
        ...
        kwargs_face['img_resolution'] = kwargs_face['img_resolution']//16
    ...
    def forward(self, img, c, update_emas=False, normal_gan=False, face_gan=False, **block_kwargs):
        ...
        img_color = {'image': img['image_raw'],
                     'image_seg': img['image_seg']}
        ...
        results = {'full': x_seg}
        results['image'] = self.D_image({'image':img['image_raw']}, c, update_emas=False, **block_kwargs)
