...
class AG3DGenerator(torch.nn.Module):
    ...
    def __init__(self,
        ...
        **synthesis_kwargs,         # Arguments for SynthesisNetwork.
        ...
        # self.backbone = StyleGAN2Backbone(z_dim, c_dim, w_dim, img_resolution=512, img_channels=16*3, mapping_kwargs=mapping_kwargs, **synthesis_kwargs)
        # self.backbone = StyleGAN2Backbone(z_dim, c_dim, w_dim, img_resolution=256, img_channels=24*3, mapping_kwargs=mapping_kwargs, **synthesis_kwargs)
