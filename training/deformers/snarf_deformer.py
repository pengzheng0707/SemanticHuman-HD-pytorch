...
class SNARFDeformer():
    ...
    def __call__(self, pts, model, eval_mode=True, render_skinning=False, is_normal=True):
        ...
        rgb_cano, sigma_cano, sdf_cano, grad_cano, grad_pred_cano = model(pts_cano_all, valid)
        ...
        return rgb_cano, sigma_cano, sdf_cano, grad, grad_pred_cano, torch.cat([pts_cano, ret_valid], -1)
